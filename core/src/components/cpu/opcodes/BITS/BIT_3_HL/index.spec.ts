...
describe("BIT_3_HL", () => {
    test("Should set zero flag if bit 3 of value from memory under register HL is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const MEMORY_INDEX = 40765;
        const MEMORY_VALUE = 16;
        const cpu = new CPU();
    ...
    test("Should unset zero flag if bit 3 of value from memory under register HL is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const MEMORY_INDEX = 40765;
        const MEMORY_VALUE = 12;
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
