...
describe("ADC_TO_REG_A_VALUE_OF_REG_H", () => {
    test("Should add value of reg H to reg A, increase PC by 1 and Subtraction flag to 0", () => {
        const cpu = new CPU();
    ...
    test("Should add value of reg H to reg A, increase PC by 1 and Subtraction flag to 0. Should respect Carry Flag", () => {
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
        const REG_A = 2;
        const REG_H = 10;
