...
describe("JMP_RELATIVE_IF_CARRY_FLAG_IS_SET", () => {
    test("Should JMP if carry flag is set", () => {
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
        const PC = 10;
        const RELATIVE_JMP_VALUE = 120;
        const EXPECTED_PC = PC + RELATIVE_JMP_VALUE + 2;
        const EXPECTED_F_REG_VALUE = 0b0010000;
    ...
    test("Should not JMP if Carry Flag is not set", () => {
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
        const PC = 10;
        const RELATIVE_JMP_VALUE = 120;
