...
describe("BIT_3_E", () => {
    test("Should set zero flag if bit 3 of register E is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_E_VALUE = 16;
        const cpu = new CPU();
    ...
    test("Should unset zero flag if bit 3 of register E is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_E_VALUE = 12;
        const cpu = new CPU();
        const memory = new Memory();
