...
describe("RLE", () => {
    test("Should rotate register E value to the left by 1 bit. Should set carry flag if bit 7 of register E is set. Carry flag set", () => {
        const REG_E_VALUE = 130;
        // << 1 + 1 from carry flag in bit 0 & 255
        const EXPETCTED_REG_E_VALUE = 5;
        const cpu = new CPU();
    ...
    test("Should rotate register E value to the left by 1 bit. Should unset carry flag if bit 7 of register E is not set. Unset carry flag set", () => {
        const REG_E_VALUE = 32;
        // << 1 + 0 from carry flag in bit 0 & 255
        const EXPETCTED_REG_E_VALUE = 64;
        const cpu = new CPU();
        const memory = new Memory();
    ...
    test("Should rotate register E value to the left by 1 bit. Should unset Zero Flag is result is not 0", () => {
        const REG_E_VALUE = 32;
        const EXPETCTED_REG_E_VALUE = 64;
        const cpu = new CPU();
        const memory = new Memory();
