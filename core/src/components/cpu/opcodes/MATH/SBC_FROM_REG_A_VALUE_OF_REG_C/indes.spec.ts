...
describe("SBC_FROM_REG_A_VALUE_OF_REG_C", () => {
    test("Should subtract value of reg B from reg C, increase PC by 1 and Subtraction flag to 1. Should substracts 1 since carry flag is set", () => {
        const cpu = new CPU();
        const memory = new Memory();
        const REG_A = 10;
        const REG_C = 2;
        const RESULT = REG_A - REG_C - 1;
    ...
    test("Should subtract value of reg C from reg A, increase PC by 1 and Subtraction flag to 1. Should NOT substracts 1 since carry flag is NOT set", () => {
        const cpu = new CPU();
        const memory = new Memory();
        const REG_A = 10;
        const REG_C = 2;
