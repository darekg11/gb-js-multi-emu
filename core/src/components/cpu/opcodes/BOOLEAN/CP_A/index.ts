...
/*
  OP Code: 0xBF
  Memonic: CP A
  Description: Subtracts from register A a value of register A and sets ZERO Flag. Result is not stored, this is used for comaprision if two values are equal
