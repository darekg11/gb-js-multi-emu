...
describe("SLAH", () => {
    test("Should rotate register H value to the left by 1 bit. Should set carry flag if bit 7 of register H is set.", () => {
        const REG_H_VALUE = 130;
        const EXPETCTED_REG_H_VALUE = 4;
        const cpu = new CPU();
    ...
    test("Should rotate register H value to the left by 1 bit. Should unset carry flag if bit 7 of register H is not set.", () => {
