...
describe("BIT_0_HL", () => {
    test("Should set zero flag if bit 0 of value from memory under register HL is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
    ...
    test("Should unset zero flag if bit 0 of value from memory under register HL is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const MEMORY_INDEX = 40765;
