...
describe("SBC_FROM_REG_A_VALUE_OF_REG_D", () => {
    test("Should subtract value of reg D from reg A, increase PC by 1 and Subtraction flag to 1. Should substracts 1 since carry flag is set", () => {
        const cpu = new CPU();
