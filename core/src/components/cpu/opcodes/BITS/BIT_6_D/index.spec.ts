...
describe("BIT_5_D", () => {
    test("Should set zero flag if bit 6 of register D is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_D_VALUE = 128;
        const cpu = new CPU();
        ...
        expect(cpu.getRegisterLValue()).toBe(0);
        expect(cpu.getRegisterBCValue()).toBe(0);
        expect(cpu.getRegisterDEValue()).toBe(REG_D_VALUE << 8);
        expect(cpu.getRegisterHLValue()).toBe(0);
    ...
    test("Should unset zero flag if bit 6 of register D is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_D_VALUE = 65;
        const cpu = new CPU();
        const memory = new Memory();
