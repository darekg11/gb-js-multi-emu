...
describe("CP_A_VALUE_FROM_NEXT_MEMORY_CELL", () => {
    test("Should not set zero flag, increase PC by 2 and Subtraction flag to 1", () => {
        const cpu = new CPU();
    ...
    test("Result of -1 should set carry flag, increase PC by 2 and Subtraction flag to 1", () => {
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
        const REG_A = 0;
        const VALUE = 1;
