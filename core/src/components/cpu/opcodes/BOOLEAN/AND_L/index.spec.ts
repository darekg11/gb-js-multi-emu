...
describe("AND L", () => {
    test("Should bitwise AND register A and register L, store result in register A. Do not set ZERO flag.", () => {
        const cpu = new CPU();
    ...
    test("Should bitwise AND register A and register L, store result in register A. Do set ZERO flag.", () => {
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
        const REG_A = 4;
        const REG_L = 1;
