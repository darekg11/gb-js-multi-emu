...
describe("LOAD_TO_MEMORY_CELL_FROM_HL_REGISTER_VALUE_OF_A_REGISTER_DECREMENT_HL_AFTER", () => {
    test("Should set value correctly and increase PC by 1 and decrement HL", () => {
