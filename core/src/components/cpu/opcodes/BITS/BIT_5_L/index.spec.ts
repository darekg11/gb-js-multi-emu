...
describe("BIT_5_L", () => {
    test("Should set zero flag if bit 5 of register L is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_L_VALUE = 64;
        const cpu = new CPU();
    ...
    test("Should unset zero flag if bit 5 of register L is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
