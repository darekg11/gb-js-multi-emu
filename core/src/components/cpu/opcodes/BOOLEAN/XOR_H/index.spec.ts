...
describe("XOR H", () => {
    test("Should bitwise XOR register A and register H, store result in register A. Do not set ZERO flag.", () => {
        const cpu = new CPU();
    ...
    test("Should bitwise XOR register A and register H, store result in register A. Do set ZERO flag.", () => {
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
        const REG_A = 4;
        const REG_H = 4;
