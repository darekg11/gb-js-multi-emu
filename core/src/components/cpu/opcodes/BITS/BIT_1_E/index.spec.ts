...
describe("BIT_1_E", () => {
    test("Should set zero flag if bit 1 of register E is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_E_VALUE = 4;
        const cpu = new CPU();
    ...
    test("Should unset zero flag if bit 1 of register E is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_E_VALUE = 3;
        const cpu = new CPU();
        const memory = new Memory();
