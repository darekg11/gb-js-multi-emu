...
describe("BIT_6_C", () => {
    test("Should set zero flag if bit 6 of register C is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_C_VALUE = 128;
        const cpu = new CPU();
    ...
    test("Should unset zero flag if bit 6 of register C is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_C_VALUE = 65;
        const cpu = new CPU();
        const memory = new Memory();
