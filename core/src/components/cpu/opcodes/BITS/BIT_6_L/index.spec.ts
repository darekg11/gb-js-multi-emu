...
describe("BIT_6_L", () => {
    test("Should set zero flag if bit 6 of register L is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_L_VALUE = 128;
        const cpu = new CPU();
        ...
        expect(cpu.getRegisterBCValue()).toBe(0);
        expect(cpu.getRegisterDEValue()).toBe(0);
        expect(cpu.getRegisterHLValue()).toBe(REG_L_VALUE);
    ...
    test("Should unset zero flag if bit 6 of register L is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_L_VALUE = 65;
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
