...
describe("LOAD_TO_REG_A_VALUE_OF_MEMORY_CELL_FROM_HL_REGISTER_INCREMENT_HL_AFTER", () => {
    test("Should set value correctly and increase PC by 1 and increment HL register", () => {
        ...
        expect(cpu.getRegisterLValue()).toBe(TEST_INDEX + 1 & 0xFF);
        expect(cpu.getRegisterBCValue()).toBe(0);
        expect(cpu.getRegisterDEValue()).toBe(0);
