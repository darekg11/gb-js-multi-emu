...
describe("SLAE", () => {
    test("Should rotate register E value to the left by 1 bit. Should set carry flag if bit 7 of register E is set.", () => {
        const REG_E_VALUE = 130;
        const EXPETCTED_REG_E_VALUE = 4;
        const cpu = new CPU();
    ...
    test("Should rotate register E value to the left by 1 bit. Should unset carry flag if bit 7 of register E is not set.", () => {
