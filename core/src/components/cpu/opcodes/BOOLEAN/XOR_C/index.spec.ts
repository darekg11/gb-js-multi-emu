...
describe("XOR C", () => {
    test("Should bitwise XOR register A and register C, store result in register A. Do not set ZERO flag.", () => {
        const cpu = new CPU();
    ...
    test("Should bitwise XOR register A and register C, store result in register A. Do set ZERO flag.", () => {
        const cpu = new CPU();
        const memory = new Memory();
        const REG_A = 4;
        const REG_C = 4;
