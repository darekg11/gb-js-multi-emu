...
describe("BIT_3_B", () => {
    test("Should set zero flag if bit 3 of register B is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_B_VALUE = 16;
        const cpu = new CPU();
