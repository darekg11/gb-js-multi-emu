...
describe("BIT_4_H", () => {
    test("Should set zero flag if bit 4 of register H is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
    ...
    test("Should unset zero flag if bit 4 of register H is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_H_VALUE = 17;
        const cpu = new CPU();
        const memory = new Memory();
