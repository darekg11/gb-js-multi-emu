...
describe("BIT_5_A", () => {
    test("Shoud set zero flag if bit 5 of register A is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_A_VALUE = 64;
        const cpu = new CPU();
    ...
    test("Should unset zero flag if bit 5 of register A is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
