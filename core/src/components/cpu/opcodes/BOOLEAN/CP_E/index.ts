...
/*
  OP Code: 0xBB
  Memonic: CP E
  Description: Subtracts from register A a value of register E and sets ZERO Flag. Result is not stored, this is used for comaprision if two values are equal
