...
import LOAD_HIGH_TO_REG_A_VALUE_OF_MEMORY_INDEX_FROM_NEXT_MEMORY_CELL_HANDLER from "./opcodes/LOAD/LOAD_HIGH_TO_REG_A_VALUE_OF_MEMORY_INDEX_FROM_NEXT_MEMORY_CELL";
import POP_AF_HANDLER from "./opcodes/STACK/POP_AF";
import LOAD_TO_REG_A_VALUE_OF_MEMORY_CELL_FROM_C_REGISTER_HANDLER from "./opcodes/LOAD/LOAD_TO_REG_A_VALUE_OF_MEMORY_CELL_FROM_C_REGISTER";
import DISABLE_INTERRUPTS_HANDLER from "./opcodes/MISCELLANEOUS/DISABLE_INTERRUPTS";
import PUSH_AF_HANDLER from "./opcodes/STACK/PUSH_AF";
import OR_A_VALUE_FROM_NEXT_MEMORY_CELL_HANDLER from "./opcodes/BOOLEAN/OR_A_VALUE_FROM_NEXT_MEMORY_CELL";
import RST_30_HANDLER from "./opcodes/STACK/RST_30";
import LOAD_TO_REG_HL_A_VALUE_OF_SP_REG_PLUS_VALUE_FROM_NEXT_MEMORY_CELL_HANDLER from "./opcodes/LOAD/LOAD_TO_REG_HL_A_VALUE_OF_SP_REG_PLUS_VALUE_FROM_NEXT_MEMORY_CELL";
import LOAD_TO_REG_SP_A_VALUE_OF_REG_HL_HANDLER from "./opcodes/LOAD/LOAD_TO_REG_SP_A_VALUE_OF_REG_HL";
import LOAD_TO_REG_A_VALUE_OF_NEXT_TWO_MEMORY_CELLS_HANDLER from "./opcodes/LOAD/LOAD_TO_REG_A_VALUE_OF_NEXT_TWO_MEMORY_CELLS";
import ENABLE_INTERRUPTS_HANDLER from "./opcodes/MISCELLANEOUS/ENABLE_INTERRUPTS";
import CP_A_VALUE_FROM_NEXT_MEMORY_CELL_HANDLER from "./opcodes/BOOLEAN/CP_A_VALUE_FROM_NEXT_MEMORY_CELL";
import RST_38_HANDLER from "./opcodes/STACK/RST_38";
import HALT_HANDLER from "./opcodes/MISCELLANEOUS/HALT";

import { IJumpTable } from "./types";

const JUMP_TABLE: IJumpTable = {
    [NON_PREFIX_OP_CODES.NOOP]: NOOP_HANDLER,
    [NON_PREFIX_OP_CODES.HALT]: HALT_HANDLER,
    ...
    [NON_PREFIX_OP_CODES.LOAD_HIGH_TO_REG_A_VALUE_OF_MEMORY_INDEX_FROM_NEXT_MEMORY_CELL]: LOAD_HIGH_TO_REG_A_VALUE_OF_MEMORY_INDEX_FROM_NEXT_MEMORY_CELL_HANDLER,
    [NON_PREFIX_OP_CODES.POP_AF]: POP_AF_HANDLER,
    [NON_PREFIX_OP_CODES.LOAD_TO_REG_A_VALUE_OF_MEMORY_CELL_FROM_C_REGISTER]: LOAD_TO_REG_A_VALUE_OF_MEMORY_CELL_FROM_C_REGISTER_HANDLER,
    [NON_PREFIX_OP_CODES.DISABLE_INTERRUPTS]: DISABLE_INTERRUPTS_HANDLER,
    [NON_PREFIX_OP_CODES.PUSH_AF]: PUSH_AF_HANDLER,
    [NON_PREFIX_OP_CODES.OR_A_VALUE_FROM_NEXT_MEMORY_CELL]: OR_A_VALUE_FROM_NEXT_MEMORY_CELL_HANDLER,
    [NON_PREFIX_OP_CODES.RST_30]: RST_30_HANDLER,
    [NON_PREFIX_OP_CODES.LOAD_TO_REG_HL_A_VALUE_OF_SP_REG_PLUS_VALUE_FROM_NEXT_MEMORY_CELL]: LOAD_TO_REG_HL_A_VALUE_OF_SP_REG_PLUS_VALUE_FROM_NEXT_MEMORY_CELL_HANDLER,
    [NON_PREFIX_OP_CODES.LOAD_TO_REG_SP_A_VALUE_OF_REG_HL]: LOAD_TO_REG_SP_A_VALUE_OF_REG_HL_HANDLER,
    [NON_PREFIX_OP_CODES.LOAD_TO_REG_A_VALUE_OF_NEXT_TWO_MEMORY_CELLS]: LOAD_TO_REG_A_VALUE_OF_NEXT_TWO_MEMORY_CELLS_HANDLER,
    [NON_PREFIX_OP_CODES.ENABLE_INTERRUPTS]: ENABLE_INTERRUPTS_HANDLER,
    [NON_PREFIX_OP_CODES.CP_A_VALUE_FROM_NEXT_MEMORY_CELL]: CP_A_VALUE_FROM_NEXT_MEMORY_CELL_HANDLER,
    [NON_PREFIX_OP_CODES.RST_38]: RST_38_HANDLER
};
