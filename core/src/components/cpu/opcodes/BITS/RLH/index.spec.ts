...
describe("RLH", () => {
    ...
    test("Should rotate register H value to the left by 1 bit. Should unset carry flag if bit 7 of register H is not set. Unset carry flag set", () => {
    ...
    test("Should rotate register H value to the left by 1 bit. Should unset Zero Flag is result is not 0", () => {
        const REG_H_VALUE = 32;
        const EXPETCTED_REG_H_VALUE = 64;
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
