...
describe("BIT_0_H", () => {
    test("Should set zero flag if bit 0 of register H is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_H_VALUE = 2;
        const cpu = new CPU();
    ...
    test("Should unset zero flag if bit 0 of register H is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_H_VALUE = 3;
        const cpu = new CPU();
        const memory = new Memory();
