...
describe("POP_DE", () => {
    test("Should store stack values in D and E registers, increase SP Register by 2, increase PC by 1", () => {
        const cpu = new CPU();
        ...
        memory.write8BitsValue(SP_INDEX, REG_E_VALUE);
        memory.write8BitsValue(SP_INDEX + 1, REG_D_VALUE);
