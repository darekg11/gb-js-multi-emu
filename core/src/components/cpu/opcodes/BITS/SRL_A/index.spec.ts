...
describe("SRL_A", () => {
    test("Should rotate register A value to the right by 1 bit. Should set carry flag if bit 0 of register A is set. Should unset zero flag if result is not zero.", () => {
        const REG_A_VALUE = 33;
        // 33 >> 1 gives 16
        // 16 & 255 === 16
    ...
    test("Should rotate register A value to the right by 1 bit. Should unset carry flag if bit 0 of register A is not set.", () => {
    ...
    test("Should rotate register A value to the right by 1 bit. Should unset carry flag if bit 0 of register A is not set. Should set zero flag if result is zero.", () => {
        const REG_A_VALUE = 0;
