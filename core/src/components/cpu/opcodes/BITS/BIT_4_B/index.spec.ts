...
describe("BIT_4_B", () => {
    test("Should set zero flag if bit 4 of register B is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
    ...
    test("Should unset zero flag if bit 3 of register B is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_B_VALUE = 18;
        const cpu = new CPU();
        const memory = new Memory();
