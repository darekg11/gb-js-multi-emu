...
describe("BIT_6_E", () => {
    test("Should set zero flag if bit 6 of register E is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_E_VALUE = 128;
        const cpu = new CPU();
        ...
        expect(cpu.getRegisterLValue()).toBe(0);
        expect(cpu.getRegisterBCValue()).toBe(0);
        expect(cpu.getRegisterDEValue()).toBe(REG_E_VALUE);
        expect(cpu.getRegisterHLValue()).toBe(0);
    ...
    test("Should unset zero flag if bit 6 of register E is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_E_VALUE = 65;
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
