...
describe("RRD", () => {
    ...
    test("Should rotate register D value to the right by 1 bit. Should unset carry flag if bit 0 of register D is not set. Unset carry flag set", () => {
        const REG_D_VALUE = 4;
    ...
    test("Should rotate register D value to the right by 1 bit. Should unset Zero Flag is result is not 0", () => {
        const REG_D_VALUE = 4;
        const EXPETCTED_REG_D_VALUE = 2;
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
