...
describe("RLA", () => {
    test("Should rotate register A value to the left by 1 bit. Should set carry flag if zero flag is set. Carry flag set", () => {
    ...
    test("Should rotate register A value to the left by 1 bit. Should set carry flag if zero flag is set. Unset carry flag set", () => {
        const REG_A_VALUE = 32;
        // << 1 + 0 from carry flag in bit 0
    ...
    test("Should rotate register A value to the left by 1 bit. Should unset carry flag if zero flag is not set. Carry flag set", () => {
        const REG_A_VALUE = 32;
        // << 1 + 1 from carry flag in bit 0
        const EXPETCTED_REG_A_VALUE = 65;
        const cpu = new CPU();
