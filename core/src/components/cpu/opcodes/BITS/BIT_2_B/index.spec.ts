...
describe("BIT_2_B", () => {
    test("Should set zero flag if bit 2 of register B is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_B_VALUE = 8;
        const cpu = new CPU();
    ...
    test("Should unset zero flag if bit 2 of register B is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_B_VALUE = 6;
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
