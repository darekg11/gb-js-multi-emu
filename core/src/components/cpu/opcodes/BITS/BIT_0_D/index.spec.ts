...
describe("BIT_0_D", () => {
    test("Should set zero flag if bit 0 of register D is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_D_VALUE = 2;
        const cpu = new CPU();
    ...
    test("Should unset zero flag if bit 0 of register D is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_D_VALUE = 3;
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
