...
describe("BIT_4_L", () => {
    test("Should set zero flag if bit 4 of register L is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
    ...
    test("Should unset zero flag if bit 4 of register L is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_L_VALUE = 17;
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
