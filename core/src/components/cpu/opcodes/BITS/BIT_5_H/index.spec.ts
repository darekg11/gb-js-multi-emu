...
describe("BIT_5_H", () => {
    test("Should set zero flag if bit 5 of register H is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_H_VALUE = 64;
        const cpu = new CPU();
    ...
    test("Should unset zero flag if bit 5 of register H is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
