...
describe("ADD_TO_REG_A_VALUE_OF_REG_E", () => {
    test("Should add value of reg E to reg A, increase PC by 1 and Subtraction flag to 0", () => {
        const cpu = new CPU();
    ...
    test("Should add value of reg E to reg A, increase PC by 1 and Subtraction flag to 0. Should respect Carry Flag", () => {
        const cpu = new CPU();
        const memory = new Memory();
        const REG_A = 2;
        const REG_E = 10;
