...
describe("BIT_6_HL", () => {
    test("Should set zero flag if bit 6 of value from memory under register HL is 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
    ...
    test("Should unset zero flag if bit 6 of value from memory under register HL is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const MEMORY_INDEX = 40765;
        const MEMORY_VALUE = 65;
        const cpu = new CPU();
        const memory = new Memory();
