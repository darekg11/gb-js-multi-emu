...
describe("ADC_TO_REG_A_VALUE_OF_REG_L", () => {
    test("Should add value of reg L to reg A, increase PC by 1 and Subtraction flag to 0", () => {
        const cpu = new CPU();
    ...
    test("Result of 16 should set half carry flag, increase PC by 1 and Subtraction flag to 0", () => {
        ...
        const REG_A = 15;
        const REG_L = 1;
        const EXPECTED_RESULT = REG_A + REG_L;
    ...
    test("Should add value of reg L to reg A, increase PC by 1 and Subtraction flag to 0. Should respect Carry Flag", () => {
        const cpu = new CPU();
        const memory = new Memory(new EventBus);
        const REG_A = 2;
        const REG_L = 10;
