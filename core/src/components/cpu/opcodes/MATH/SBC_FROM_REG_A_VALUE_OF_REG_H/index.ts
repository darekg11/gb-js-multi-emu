...
/*
  OP Code: 0x9C
  Memonic: SBC A, H
  Description: Subtracts from register A a value of registerHE. Subtracts carry flag value from register A.
...
const handle = (payload: IOpCodeHanlePayload): number => {
    ...
    const diff = registerAValue - registerHValue - (isCarryFlagSet ? 1 : 0)
    if (diff < 0) {
