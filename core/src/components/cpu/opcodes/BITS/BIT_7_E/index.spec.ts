...
describe("BIT_7_E", () => {
    test("Should unset zero flag if bit 7 of register E is not 0. Subtraction flag should be unset, Half carry flag should be set, Carry flag unchaged.", () => {
        const REG_E_VALUE = 255;
        const cpu = new CPU();
