...
/*
  OP Code: 0xBC
  Memonic: CP H
  Description: Subtracts from register A a value of register H and sets ZERO Flag. Result is not stored, this is used for comaprision if two values are equal
